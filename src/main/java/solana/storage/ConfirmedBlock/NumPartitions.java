...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return SolanaStorage.internal_static_solana_storage_ConfirmedBlock_NumPartitions_descriptor;
  }

  @Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return SolanaStorage.internal_static_solana_storage_ConfirmedBlock_NumPartitions_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            NumPartitions.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof NumPartitions)) {
      return super.equals(obj);
    }
    NumPartitions other = (NumPartitions) obj;
  ...
  public static NumPartitions parseFrom(
  ...
  public static NumPartitions parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static NumPartitions parseFrom(
  ...
  public static NumPartitions parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static NumPartitions parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static NumPartitions parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(NumPartitions prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using solana.storage.ConfirmedBlock.NumPartitions.newBuilder()
    private Builder() {
    ...
    @Override
    public NumPartitions getDefaultInstanceForType() {
      return NumPartitions.getDefaultInstance();
    }

    @Override
    public NumPartitions build() {
      NumPartitions result = buildPartial();
    ...
    @Override
    public NumPartitions buildPartial() {
      NumPartitions result = new NumPartitions(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof NumPartitions) {
        return mergeFrom((NumPartitions)other);
      } else {
    ...
    public Builder mergeFrom(NumPartitions other) {
      if (other == NumPartitions.getDefaultInstance()) return this;
  ...
  private static final NumPartitions DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new NumPartitions();
  }

  public static NumPartitions getDefaultInstance() {
